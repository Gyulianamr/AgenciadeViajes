...
namespace AgenciadeViajesDevExtremeMvC.Controllers
{
    public class GuiaTuristicoController : ApiController
    {
        ...
        {
            var apiUrl = "https://localhost:44321/api/GuiaTuristico";

            var respuestaJson = await GetAsync(apiUrl);
            //System.Diagnostics.Debug.WriteLine(respuestaJson); imprimir info
            List<GuiaTuristico> listaGuia = JsonConvert.DeserializeObject<List<GuiaTuristico>>(respuestaJson);
            return Request.CreateResponse(DataSourceLoader.Load(listaGuia, loadOptions));
        }
        ...
        public async Task<HttpResponseMessage> Post(FormDataCollection form)
        {
            ...
            var url = "https://localhost:44321/api/GuiaTuristico";
            var handler = new HttpClientHandler();
            handler.ServerCertificateCustomValidationCallback = (message, cert, chain, errors) => true;
            using (var client = new HttpClient(handler))
            {
        ...
        public async Task<HttpResponseMessage> Put(FormDataCollection form)
        {
            ...
            var apiUrlGetPeli = "https://localhost:44321/api/GuiaTuristico/" + key;
            ...
            using (var client = new HttpClient(handler))
            {
                var url = "https://localhost:44321/api/GuiaTuristico/" + key;
        ...
        public async Task<HttpResponseMessage> Delete(FormDataCollection form)
        {
            ...
            var apiUrlDelPeli = "https://localhost:44321/api/GuiaTuristico/" + key;
            var handler = new HttpClientHandler();
            handler.ServerCertificateCustomValidationCallback = (message, cert, chain, errors) => true;
            using (var client = new HttpClient(handler))
            {
